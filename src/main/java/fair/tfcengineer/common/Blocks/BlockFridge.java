...
public class BlockFridge extends BlockTFCESidedContainer {
    ...
    public void registerBlockIcons(IIconRegister reg) {
        registerSidedIcons(reg, 0, // Off state
                "fridgetop", "fridgetop", // bot, top
                "fridgefront", "fridgeside", // front, back
                "fridgeside", "fridgeside"); // right, left
        registerSidedIcons(reg, 1, // On state
                "fridgetop", "fridgetop",
                "fridgefronton", "fridgeside",
